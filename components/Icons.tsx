...
export const VolumeMuteIcon: React.FC<IconProps> = ({ size = 24, className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
    <path d="M16.5 12c0-1.77-1.02-3.29-2.5-4.03v1.79l2.48 2.25.02-.01zm-6.5 0c0 .83.26 1.65.77 2.32l1.49-1.49c-.12-.29-.19-.61-.19-.83 0-.63.3-1.22.77-1.6l-1.49-1.49c-.51.67-.77 1.49-.77 2.32zM19 12c0 1.1-.9 2-2 2v4c1.1 0 2-.9 2-2s-.9-2-2-2v4c1.1 0 2-.9 2-2zm-4-8h-1.5v2H15c.55 0 1 .45 1 1v4c0 .55-.45 1-1 1h-1.5v2h1.5c1.38 0 2.5-1.12 2.5-2.5V7.5c0-1.38-1.12-2.5-2.5-2.5z"/>
  </svg>
);
...
export const RepeatOneIcon: React.FC<IconProps> = ({ size = 24, className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
    <path d="M7 7h10v3l4-4-4-4v3H5v6h2V7zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2v4zm-4-2V9h-1l-2 1v1h1.5v4h.5z"/>
  </svg>
);
...
export const SpeedIcon: React.FC<IconProps> = ({ size = 24, className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
    ...
    <path d="M10.59 15.41a2 2 0 0 0 2.83 0l5.66-8.49-1.17-1.17L12 13.17l-5.91-8.83-1.16 1.17 5.66 8.49z"/>
  </svg>
);
...
export const HeartIcon: React.FC<IconProps & { fill?: string }> = ({ size = 24, className, fill = 'none' }) => (
...
export const SkipBack30Icon: React.FC<IconProps> = ({ size = 24, className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
    <path d="M11 19l-7-7 7-7" />
    <path d="M19 19l-7-7 7-7" />
    <text x="50%" y="60%" textAnchor="middle" fontSize="6" fontWeight="bold" fill="currentColor" stroke="none" transform="translate(0, 4)">30</text>
  </svg>
);

export const SkipForward30Icon: React.FC<IconProps> = ({ size = 24, className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
...
export const BookmarkIcon: React.FC<IconProps> = ({ size = 24, className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
